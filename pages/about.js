    ...
    <div className="container">
      ...
      <article className="about-container">
        ...
        <section className="team-container">
          ...
          <hr className="about__break-line"></hr>

          <div className="team-card">
            <div className="team-card__image-left">
              <img className="team-image-left" src="/justin.jpg" alt="Photo of Justin"/>
            </div>
            <h2 className="team-card__title-left">Development Team Leader/ Front-End Developer: Justin Kang</h2>
            <div className="team-card__text-left">
              <p>Justin is a 4th year Computer Science Major with a minor in Statistics. Justin specializes in Intelligent Systems, Machine Learning, and Creation/Analysis of Statistical Models.</p>
            </div>
          
            <div className="team-card__image-right">
              <img className="team-image-right" src="/mugdha.jpg" alt="Photo of Mugdhaa"/>
            </div>
            <h2 className="team-card__title-right">Back-End Developer: Mugdhaa Patankar</h2>
            <div className="team-card__text-right">
              <p>Mugdhaa is a 3rd year Computer Science Major with a specialization in Information. An experienced web developer, who’s strengths shine in Back-End Development.</p>
            </div>
          </div>
          <div className="team-card">
            <div className="team-card__image-left">
              <img className="team-image-left" src="/gabe.jpg" alt="Photo of Gabe"/>
            </div>
            <h2 className="team-card__title-left">Back-End Developer: Gabe De Mesa</h2>
            <div className="team-card__text-left">
              <p>Gabe is a 3rd year Computer Science Major, who enjoys working with data bases and big data, also specializes in Information.</p>
            </div>
          
            <div className="team-card__image-right">
              <img className="team-image-right" src="/patrick.jpg" alt="Photo of Patrick"/>
            </div>
            <h2 className="team-card__title-right">Front-End Developer: Patrick Castillofuentes</h2>
            <div className="team-card__text-right">
              <p>Patrick is a 5th Year Computer Science Major. He specializes in network security and cryptography, in addition to having background in graphic design.  </p>
            </div>
          </div>
